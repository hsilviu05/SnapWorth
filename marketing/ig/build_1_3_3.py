#!/usr/bin/env python3
"""Generate the SnapWorth 1.3.3 Instagram post (1080x1350) as PNGs.

Source of truth is the design canvas artboards in marketing/ig/dc-1.3.3/*.dc.html,
...
serif is visibly wrong), then renders with headless Chrome.
    ...
    python3 marketing/ig/build_1_3_3.py
"""
import base64, pathlib, re, subprocess, sys

ROOT = pathlib.Path(__file__).resolve().parents[2]
FONTS = ROOT / "website" / "fonts"
DC = pathlib.Path(__file__).resolve().parent / "dc-1.3.3"
...
POSTS = {
    "FreeScan.dc.html": "post1_133_freescan",
}
